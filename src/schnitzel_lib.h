...
/*
 * Reads a file into a supplied buffer.  We managed our own
 * memory and therefore want mroe control over where it is
 * allocated
 */
...
//                                WAV File Stuff
// #####################################################################################
// Wave Files are separated into chunks,
// struct chunk
// {
//      unsigned int id;
